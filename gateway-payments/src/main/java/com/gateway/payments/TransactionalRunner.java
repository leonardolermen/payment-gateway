 ...
 *
 * <p>Named {@code Runner} because that is what it is and because it is how this repository spells "this
 * class is wiring, not model" — the distinction {@code ArchitectureTest}'s {@code modelsHaveNoSpring}
 * enforces.
 */
