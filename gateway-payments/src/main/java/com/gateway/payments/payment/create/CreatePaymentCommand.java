...
/**
 * What the edge asks for, already in the domain's vocabulary. Sealed on purpose: a third method
 * must not be addable without the compiler pointing at everything that has to learn about it.
 *
