...
class OutboxEntity {
  ...
  @Column(name = "aggregate_id", length = 26, nullable = false) @JdbcTypeCode(SqlTypes.CHAR) String aggregateId;
  @Column(name = "partition_key", length = 64) String partitionKey;
  @Column(name = "event_type", nullable = false, length = 60) String eventType;
