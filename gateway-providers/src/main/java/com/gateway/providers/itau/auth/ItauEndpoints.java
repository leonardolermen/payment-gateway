 ...
 * (plain OAuth, no client certificate) — see docs/providers/itau/NOTES.md, "Sandbox
 * authentication".
 */
public record ItauEndpoints(URI apiBase, URI tokenUrl, boolean mutualTls) {
  ...
  private static final URI LIVE_API_BASE =
      URI.create("https://pix-pj.api.itau.com/regulatorio-pix/v2");
  ...
  private static final URI TEST_TOKEN_URL =
      URI.create("https://sandbox.devportal.itau.com.br/api/oauth/jwt");
  ...
  // at the
  // same STS path as Pix (APIGatewaySTSAuthorizer); cash_management declares its own tokenUrl in
  // its
  // OpenAPI securitySchemes. Sandbox: all three behind the portal, same /api/oauth/jwt, no mTLS.
  private static final URI LIVE_BOLETO_ISSUE_BASE =
      URI.create("https://pix-pj.api.itau.com/recebimentos-pix/v1");
  private static final URI LIVE_BOLETO_QUERY_BASE =
      URI.create("https://secure.api.cloud.itau.com.br/boletoscash/v2");
  private static final URI LIVE_BOLETO_INSTRUCTION_BASE =
      URI.create("https://api.gateway.itau.com.br/cash_management/v2");
  public static final URI CASH_MANAGEMENT_TOKEN_URL =
      URI.create("https://sts.itau.com.br/api/oauth/token");
  private static final URI TEST_BOLETO_ISSUE_BASE =
      URI.create("https://sandbox.devportal.itau.com.br/itau-ep9-api-recebimentos-v1-externo/v1");
  private static final URI TEST_BOLETO_QUERY_BASE =
      URI.create(
          "https://sandbox.devportal.itau.com.br/itau-ep9-gtw-boletoscash-boletoscash-v2-ext-aws/v1");
  private static final URI TEST_BOLETO_INSTRUCTION_BASE =
      URI.create("https://sandbox.devportal.itau.com.br/itau-ep9-gtw-cash-management-ext-v2/v2");
