...
class PixAmountsTest {
  ...
  @Test
  void rejectsWhatBacenRejects() {
    assertThatThrownBy(() -> PixAmounts.toItau(Money.brl(0)))
        .isInstanceOf(IllegalArgumentException.class);
    assertThatThrownBy(() -> PixAmounts.toItau(Money.brl(1_000_000_000_001L)))
        .isInstanceOf(IllegalArgumentException.class);
    assertThatThrownBy(() -> PixAmounts.fromItau("1,00"))
        .isInstanceOf(IllegalArgumentException.class);
    assertThatThrownBy(() -> PixAmounts.fromItau("1.5"))
        .isInstanceOf(IllegalArgumentException.class);
  }
}
