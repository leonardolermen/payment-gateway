...
final class TestCertificates {
  ...
  static Bundle generate() throws Exception {
    ...
    serverKeyStore.setKeyEntry("server", serverKeys.getPrivate(), serverPassword, new X509Certificate[] {serverCert, caCert});

    return new Bundle(caTrust, toPem(clientCert), toPem(clientKeys.getPrivate()), serverKeyStore, serverPassword);
  }
