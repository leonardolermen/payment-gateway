...
class EnvelopeCipherTest {
  ...
  void encryptsAndDecryptsWithAad() {
    ...
    assertThat(new String(e.ciphertext(), StandardCharsets.ISO_8859_1))
  ...
  @Test
  void freshNonceAndDekPerEncryption() {
  ...
  void wrongMasterKeyFails() {
    ...
    assertThatThrownBy(() -> new EnvelopeCipher(MasterKey.randomForTests()).decrypt(e, "m"))
        .isInstanceOf(SecurityException.class);
  }

  @Test
  void masterKeyMustBe32Bytes() {
    assertThatThrownBy(() -> MasterKey.fromBase64("AAAA"))
