...
class ApiKeyTest {
  ...
  @Test
  void issuesWithEnvironmentPrefixAndStoresOnlyTheHash() {
    ...
    assertThat(issued.apiKey().hash())
        .isEqualTo(ApiKey.hashOf(plain, PEPPER))
  ...
  @Test
  void environmentComesFromThePrefix() {
  ...
  @Test
  void revokedOrExpiredIsInvalid() {
