...
public record ApiKeyIssuedResponse(String id, String prefix, com.gateway.merchants.apikey.ApiKeyEnvironment environment, String key, String warning) {
  public static ApiKeyIssuedResponse from(ApiKey.Issued issued) {
    ApiKey apiKey = issued.apiKey();
    return new ApiKeyIssuedResponse(apiKey.id(), apiKey.prefix(), apiKey.environment(), issued.plainKey().reveal(),
