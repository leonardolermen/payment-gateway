 ...
 *
 * <p>Each subtype declares only its own fields, so a field belonging to the other method is refused
 ...
 */
// visible is left off on purpose: the resolver consumes `method` and does not pass it down, so
// neither
