 ...
 * ("must be 8 digits"): the type does not know it is called {@code customer.address.zip} in the API,
 * so whoever builds the aggregate composes the field path and the error code from it.
 *
